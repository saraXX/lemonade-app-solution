    ...
    private fun clickLemonImage() {
        ...
        when(lemonadeState){
            SELECT -> {
                ...
                squeezeCount = 0
                Log.d(TAG, "clickLemonImage: lemonada State is ${lemonadeState} " +
                        "\n lemon size is ${lemonSize}, \n squeeze count is ${squeezeCount}")
            }
            SQUEEZE -> {
                squeezeCount++
                lemonSize--
            ...
            DRINK -> {
                ...
                Log.d(TAG, "clickLemonImage: lemonafeState is "+lemonadeState)
            }
            RESTART -> {
